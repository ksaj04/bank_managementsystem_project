						...
						<div class="container-fluid">
							<ul class="navbar-nav d-flex justify-content-around w-100">
								<li class="nav-item mx-3"><a class="nav-link"
									style="color: white;" onclick="accountinfo()"> <i
										class="fa fa-info-circle"></i> Account Information
								</a></li>
								<li class="nav-item mx-3"><a class="nav-link"
									style="color: white;" onclick="checkbalance()"> <i
										class="fa fa-money"></i> Bank Balance
								</a></li>
								<li class="nav-item mx-3"><a class="nav-link"
									style="color: white;" onclick="transfermoney()"> <i
										class="fa fa-exchange"></i> Money Transfer
								</a></li>
								<li class="nav-item mx-3"><a class="nav-link"
									style="color: white;" onclick="todaytrans()"> <i
										...
										<div class="container-fluid">
											<ul class="navbar-nav d-flex justify-content-around w-100">
												<li class="nav-item mx-3"><a class="nav-link active"
													style="color: white;" onclick="todaytrans()"> <i
														class="fa fa-calendar"></i> Today
												</a></li>
												<li class="nav-item mx-3"><a class="nav-link"
													style="color: white;" onclick="oneweek()"> <i
														class="fa fa-calendar-o"></i>One Week
												</a></li>
												<li class="nav-item mx-3"><a class="nav-link"
													style="color: white;" onclick="thisweek()"><i
														class="fa fa-exchange"></i>This Week </a></li>
												<li class="nav-item mx-3"><a class="nav-link"
													style="color: white;" onclick="onemonth()"><i
														class="fa fa-calendar"></i>One Month </a></li>
												<li class="nav-item mx-3"><a class="nav-link"
													style="color: white;" onclick="thismonth()"> <i
														class="fa fa-calendar"></i>This Month
												</a></li>
												<li class="nav-item mx-3"><a class="nav-link"
													style="color: white;" onclick="customdetails()"> <i
														class="fa fa-cogs"></i>Customize
												</a></li>
											</ul>
										</div>
									</nav>
